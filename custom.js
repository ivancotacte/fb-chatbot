        ...
        async () => {
          api.getThreadList(10, null, ["INBOX"], (err, data) => {
            data.forEach((info) => {
              if (info.isGroup && info.isSubscribed) {
                api.sendMessage(
                  "Good morning everyone! (This is an automated message)",
                  info.threadID,
                );
              }
            });
        ...
        async () => {
          api.getThreadList(10, null, ["INBOX"], (err, data) => {
            data.forEach((info) => {
              if (info.isGroup && info.isSubscribed) {
                api.sendMessage(
                  "Good afternoon everyone! (This is an automated message)",
                  info.threadID,
                );
              }
            });
        ...
        async () => {
          api.getThreadList(10, null, ["INBOX"], (err, data) => {
            data.forEach((info) => {
              if (info.isGroup && info.isSubscribed) {
                api.sendMessage(
                  "Good evening everyone! (This is an automated message)",
                  info.threadID,
                );
              }
            });
        ...
        async () => {
          api.getThreadList(10, null, ["INBOX"], (err, data) => {
            data.forEach((info) => {
              if (info.isGroup && info.isSubscribed) {
                api.sendMessage(
                  "Good night everyone! (This is an automated message)",
                  info.threadID,
                );
              }
            });
